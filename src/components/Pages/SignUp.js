...
const SignUp = () => {
    ...
    const submitHandler = async (e) => {
        ...
        let url;
        if (isLogin) {
            url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA68Q47asUmnoqKcBJYZKauh_E3-YnTnVk';
        } else {
            url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA68Q47asUmnoqKcBJYZKauh_E3-YnTnVk';
        }
